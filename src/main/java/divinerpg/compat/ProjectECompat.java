...
public class ProjectECompat {
	...
	public static void init() {
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.aquaticIngot, 1, 0), 3000L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.arlemiteIngot, 1, 0), 2300L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.hellstoneIngot, 1, 0), 10000L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.netheriteIngot, 1, 0), 700L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.realmiteIngot, 1, 0), 640L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.rupeeIngot, 1, 0), 2400L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.corruptedShards, 1, 0), 890L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.enderShards, 1, 0), 840L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.jungleShards, 1, 0), 500L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.moltenShards, 1, 0), 640L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.terranShards, 1, 0), 500L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.iceShards, 1, 0), 700L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.watchingEye, 1, 0), 766L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(BlockRegistry.twilightStone, 1, 0), 1L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.edenSoul, 1, 0), 712L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.wildwoodSoul, 1, 0), 814L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.apalachiaSoul, 1, 0), 1024L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.skythernSoul, 1, 0), 1250L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.mortumSoul, 1, 0), 1500L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.edenFragments, 1, 0), 712L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.wildwoodFragments, 1, 0), 814L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.apalachiaFragments, 1, 0), 1024L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.skythernFragments, 1, 0), 1250L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.mortumFragments, 1, 0), 1500L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.bloodgem, 1, 0), 500L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.purpleBlaze, 1, 0), 1300L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.sharkFin, 1, 0), 1200L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.crabClaw, 1, 0), 200L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.whaleFin, 1, 0), 1508L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.liopleurodonSkull, 1, 0), 13950L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.liopleurodonTeeth, 1, 0), 1200L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.cyclopsEye, 1, 0), 415L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.aquaticPellets, 1, 0), 400L);
		...
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(BlockRegistry.arcaniumOre, 1, 0), 20000L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.teleportationStar, 1, 0), 64000L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.rawEmpoweredMeat, 1, 0), 250L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.forbiddenFruit, 1, 0), 16L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.fruitCake, 1, 0), 2500L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.enrichedMagicMeat, 1, 0), 500L);
		...
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.arcaniumAttractor, 1, 0), 20000L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.arcaniumReflector, 1, 0), 20000L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.divineAccumulator, 1, 0), 20000L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.ghostbane, 1, 0), 40000L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.orbOfLight, 1, 0), 40000L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.staffOfEnrichment, 1, 0), 4000L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.wizardsBook, 1, 0), 4000L);
		...
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.weakArcanaPotion, 1, 0), 1000L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.strongArcanaPotion, 1, 0), 2000L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.collector, 1, 0), 120L);
		...
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(BlockRegistry.skythernBrush, 1, 0), 20L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(BlockRegistry.demonBrambles, 1, 0), 20L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(BlockRegistry.eyePlant, 1, 0), 20L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(BlockRegistry.mortumBrush, 1, 0), 20L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(BlockRegistry.wildwoodVine, 1, 0), 16L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.edenDust, 1, 0), 25L);
		ProjectEAPI.getEMCProxy().registerCustomEMC(new ItemStack(ItemRegistry.wildwoodDust, 1, 0), 50L);
